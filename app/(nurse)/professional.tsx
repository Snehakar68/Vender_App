...
const pickFile = async () => {
  ...
  const validate = () => {
    ...
    if (!formData.regDate)
      newErrors.regDate = "Registration Date required";

      if (!file && !licenseBase64) {
    newErrors.certificate = "Registration certificate required";
  }
  ...
  handleChange("experience", cleaned);
}}
          />
          {errors.experience && (
  ...
  <View style={styles.successModalOverlay}>
    <View style={styles.successModalBox}>
      ...
      <Text style={styles.successModalText}>
        Proffessional information updated successfully.
      </Text>
